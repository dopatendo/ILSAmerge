...
#' @param combinerespondents a logical value indicating if respondents should be 
#' combined.
...
#' ILSAready("RLII",1991,outputdir = output, agreeLicense = TRUE,quiet = TRUE)
#' 
#' # List of ready files
#' list.files(output)
#' 
...
ILSAready <- function(study, year, outputdir = getwd(), combinerespondents = TRUE,
